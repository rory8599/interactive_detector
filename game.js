...
//import GenParticle from "./GenParticle";
...
class GenParticle extends React.Component{
    constructor(props){
        ...
        //particle = this.detector_events.current
    }

    componentDidMount(){
        let particle = this.detector_events.current // reference to the detector_events element
    ...
    componentDidUpdate(){
        ...
        let particle = this.detector_events.current
        ...
        return(
            <div id = "main_app">
                <div className="app_initoutput">
                    ...
                    <p id="detector_events" ref={this.detector_events}>
...
class InputDisplay extends React.Component{
    ...
    render(){
        //let {userParticle} = this.props
        return(
            <p>{this.props.userParticle}</p>
        );
    }
}*/
